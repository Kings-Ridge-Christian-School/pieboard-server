...
db.serialize(() => {
    db.run("CREATE TABLE IF NOT EXISTS devices (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, ip TEXT, manifest TEXT, authentication TEXT, lastSuccess INT, groups TEXT)");
